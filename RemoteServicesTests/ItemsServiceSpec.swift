        ...
        describe("the Items Service") {
            ...
            context("when the response is correct") {
                ...
                it("contains the correct item information") {
                    ...
                    let item = Item(id: 4, name: "Pinterest", color: UIColor(red: 221/255, green: 81/255, blue: 69/255, alpha: 1), iconURL: NSURL(string: "https://business.pinterest.com/sites/business/files/bg-basics-badge-02.jpg")!)
